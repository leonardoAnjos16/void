...
struct FeedbackView: View {    
    ...
    @State private var item: Feedback = Feedback(content: Message(author: "Yasmin Santos Araújo", message: "Gostei bastante da aula, acho que foi em um ritmo legal.", time: Date.now), id: 0, threadMessages: [Message(author: "Livia", message: "Obrigado pelo feedback, vou tentar manter esse ritmo :)", time: Date.now), Message(author: "Livia", message: "Obrigado pelo feedback, vou tentar manter esse ritmo :)", time: Date.now)]);
